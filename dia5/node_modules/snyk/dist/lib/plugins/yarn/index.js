...
function generateDependenciesFromLockfile(root, options, targetFile) {
    return __awaiter(this, void 0, void 0, function () {
        var lockFileFullPath, fullPath, manifestFileFullPath, manifestFile, lockFile, defaultManifestFileName, strictOutOfSync;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    ...
                    strictOutOfSync = _.get(options, 'strictOutOfSync', true);
                    return [2 /*return*/, lockFileParser.buildDepTree(manifestFile, lockFile, options.dev, lockFileParser.LockfileType.yarn, strictOutOfSync, defaultManifestFileName)];
            }
        });
    });
}
